...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <ul id="menu-principale"><h2>New Entry:</h2></ul>
        ...
        <div class="container">
          ...
          <div class="image-container">
          <a href="../pagine/peterpan.php"><img src="../immagini/peterpan.png"></a>
            <div class="text-box">
              <a href="../pagine/peterpan.php">
              <h2>Peter Pan</h2>
              </a>
              <p>Peter Pan: il film disney rivisitato in una versione totalmente nuova.</p>
            </div>
          </div>
        </div>
