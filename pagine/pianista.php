...
<div class="scritta">Guarda un film</div></div>
    ...
    $comment = $_POST['comment'];
      ...
      if(!empty($comment)){
        $comment = mysqli_real_escape_string($conn, $comment);
          ...
          $insert_query = "INSERT INTO comments (comment,utente,pagina)VALUES ('$comment','$username','pianista')";
    ...
    <?php
      ...
      $select_query = "SELECT * FROM comments WHERE pagina='pianista' ORDER BY created_at DESC";
