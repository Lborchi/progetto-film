...
<html lang="en">
<head>
    <title>Una notte da leoni</title>
...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <div class="container1">
            <div class="image-container1">
                <img src="../immagini/nottedaleoni.png">
              <div class="text-box1">
    ...
    $comment = $_POST['comment'];
      ...
      if(!empty($comment)){
        $comment = mysqli_real_escape_string($conn, $comment);
          ...
          $insert_query = "INSERT INTO comments (comment,utente,pagina)VALUES ('$comment','$username','notte')";
    ...
    <?php
      ...
      $select_query = "SELECT * FROM comments WHERE pagina='notte' ORDER BY created_at DESC";
