...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <ul id="menu-principale"><h2>Film D'Azione:</h2></ul>

        <div class="container">
          <div class="image-container">
            <a href="../pagine/jamesbond.php"><img src="../immagini/jamesbond.png"></a>
            <div class="text-box">
              <a href="../pagine/jamesbond.php">
              <h2>No Time To Die: recensione del nuovo film 007 </h2>
              </a>
              <p>No time to die, diretto da David F. Sandberg, con Zachary Levi ed Helen Mirren tra i protagonisti del cast. Questa è la recensione.</p>
            </div>
          </div>
          <div class="image-container">
            <a href="../pagine/johnwick.php"><img src="../immagini/johnwick.png"></a>
            <div class="text-box">
              <a href="../pagine/johnwick.php">
