...
<html lang="en">
<head>
    <title>La legggenda del pianista sull'oceano</title>
...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <div class="container1">
            <div class="image-container1">
                <img src="../immagini/pianistaoceano.png">
              <div class="text-box1">
                <h2>Shazam! Furia degli Dei: recensione del nuovo film DC</h2>
                <p id="firma">DI LUCA BORCHIERO</p>
                <br>
                <p id="titoletto">Shazam! Furia degli Dei è il nuovo film DC, diretto da David F. Sandberg, con Zachary Levi ed Helen Mirren tra i protagonisti del cast. Questa è la recensione.</p>
                <br>
    ...
    $comment = $_POST['comment'];
      ...
      if(!empty($comment)){
        $comment = mysqli_real_escape_string($conn, $comment);
          ...
          $insert_query = "INSERT INTO comments (comment,utente,pagina)VALUES ('$comment','$username',pianistaoceano)";
    ...
    <?php
      ...
      $select_query = "SELECT * FROM comments WHERE pagina='pianistaoceano' ORDER BY created_at DESC";
