...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <ul id="menu-principale"><h2>Film Di Fantascienza:</h2></ul>
        <div class="container">
          <div class="image-container">
            <a href="../pagine/avatar.php"><img src="../immagini/avatar.png"></a>
            <div class="text-box">
              <a href="../pagine/avatar.php">
                <h2>Avatar: il nuovo film fanasy con una risoluzione computerizzata innovativa </h2>
              </a>
              <p>Avatar è un film del 2009 diretto da James Cameron.</p>
            </div>
          </div>
          <div class="image-container">
            <a href="../pagine/guardiani.php"><img src="../immagini/guardiani.png"></a>
            <div class="text-box">
              <a href="../pagine/guardiani.php">
              <h2>Guardiani Della Galassia: il nuovo film firmato Marvel</h2>
              </a>
              <p>Dopo la morte di sua madre a causa di un tumore, un bambino viene preso dai Ravagers, un gruppo di pirati contrabbandieri extraterrestri guidati dal loro capo Yondu Udonta.</p>
            </div>
          </div>
          <div class="image-container">
              <a href="../pagine/avatar2.php"><img src="../immagini/avatar2.png"></a>
            <div class="text-box">
              <a href="../pagine/avatar2.php">
                <h2>Avatar: il sequel del film fanasy leggendario con una risoluzione computerizzata innovativa </h2>
              </a>
              <p>Avatar 2: La Via dell'Acqua, il film diretto da James Cameron, è il sequel in live action del film campione d'incassi Avatar del 2009.</p>
            </div>
          </div>
        </div>
