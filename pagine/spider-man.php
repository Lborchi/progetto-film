...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <div class="container1">
            <div class="image-container1">
                <img src="../immagini/spider-man.png">
              <div class="text-box1">
    ...
    $comment = $_POST['comment'];
      ...
      if(!empty($comment)){
        $comment = mysqli_real_escape_string($conn, $comment);
          ...
          $insert_query = "INSERT INTO comments (comment,utente,pagina)VALUES ('$comment','$username',spider)";
    ...
    <?php
      ...
      $select_query = "SELECT * FROM comments WHERE pagina='spider' ORDER BY created_at DESC";
