...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <ul id="menu-principale"><h2>Contatti:</h2></ul>
    <div id="testo">
        <div>Per informazioni generiche, richieste di carattere redazionale, rettifiche e malfunzionamenti contattare uno dei due capo redattori:</div>
        <br>
        <div>Luca Borchiero:</div>
        <div>indirizzo gmail: <a id="gmail" href="mailto:luca.borchiero@gmail.com">luca.borchiero@gmail.com</a></div>
        <div>numero di telefono: <a id="tel" href="tel:+393319527198">+393319527198</a></div>
        <br>
        <div>Emanuele Colzani:</div>
        <div>indirizzo gmail: <a id="gmail" href="mailto:emanuele.colzani@liceobanfi.eu">emanuele.colzani@liceobanfi.eu</a></div> 
        <div>numero di telefono: <a id="tel" href="tel:+393920240134">+393920240134</a></div>   
    </div>
