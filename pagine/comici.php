...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <ul id="menu-principale"><h2>Film Comici:</h2></ul>
        <div class="container">
          <div class="image-container">
            <a href="../pagine/quovado.php"><img src="../immagini/quovado.png"></a>
            <div class="text-box">
              <a href="../pagine/quovado.php">
              <h2>Quo Vado?, la recensione del film di Checco Zalone e Gennaro Nunziante</h2>
              </a>
              <p>Il quarto film di Checco Zalone non delude e offre un ottimo esempio di commedia ben calata nella realtà nazionale. Ecco qui la recensione</p>
            </div>
          </div>
          <div class="image-container">
            <a href="../pagine/murdermistery.php"><img src="../immagini/murdermistery.png"></a>
            <div class="text-box">
              <a href="../pagine/murdermistery.php">
          ...
          <div class="image-container">
              <a href="../pagine/nottedaleoni.php"><img src="../immagini/nottedaleoni.png"></a>
            <div class="text-box">
              <a href="../pagine/nottedaleoni.php">
