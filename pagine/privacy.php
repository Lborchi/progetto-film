...
<head>
  ...
  <div class="dropdown-content">
    ...
    <div class="scritta">Guarda un film</div></div>
        ...
        <ul id="menu-principale"><h2>Privacy:</h2></ul>
    <div id="testo">
        <div>
        ...
        <div>
            Indirizzo del Titolare: via Armando Diaz,11 - 20862 Monza(Mb) - Italia
        </div>
        <div>
            Indirizzo e-mail del Titolare:<a id="gmail" href="mailto:luca.borchiero@gmail.com"> luca.borchiero@gmail.com</a>
        </div>
        <br>
        <div id="termini">
        ...
        <div>
            Fra i Dati Personali raccolti da questa Applicazione, in modo autonomo o tramite terze parti, ci sono: varie tipologie di Dati.
        ...
        <div id="termini">
            Luogo di conservazione dei Dati raccolti
        </div>
        <div>
        ...
        <div>
            I Dati dell’Utente sono raccolti per consentire al Titolare di fornire i propri Servizi, così come per le seguenti finalità: Trasferimento di Dati al di fuori della UE.
