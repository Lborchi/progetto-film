...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <ul id="menu-principale"><h2>Film d'Animazione:</h2></ul>

        <div class="container">
          <div class="image-container">
            <a href="../pagine/toystory.php"><img src="../immagini/toystory.png"></a>
            <div class="text-box">
              <a href="../pagine/toystory.php">
          ...
          <div class="image-container">
            <a href="../pagine/cars.php"><img src="../immagini/cars.png"></a>
            <div class="text-box">
              <a href="../pagine/cars.php">
          ...
          <div class="image-container">
              <a href="../pagine/spider-man.php"><img src="../immagini/spider-man.png"></a>
            <div class="text-box">
              <a href="../pagine/spider-man.php">
