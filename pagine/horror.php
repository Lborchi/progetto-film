...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <ul id="menu-principale"><h2>Film Horror:</h2></ul>

        <div class="container">
          <div class="image-container">
            <a href="../pagine/bambola.php"><img src="../immagini/bambola.png"></a>
            <div class="text-box">
              <a href="../pagine/bambola.php">
          ...
          <div class="image-container">
            <a href="../pagine/megan.php"><img src="../immagini/megan.png"></a>
            <div class="text-box">
              <a href="../pagine/megan.php">
              <h2>Megan</h2>
              </a>
              <p>Megan: il film adatto ad una serata da soli a casa.</p>
            </div>
          </div>
          <div class="image-container">
              <a href="../pagine/ring.php"><img src="../immagini/ring.png"></a>
            <div class="text-box">
              <a href="../pagine/ring.php">
              <h2>The Ring è un film del 2002 diretto da Gore Verbinski.</h2>
              </a>
              <p>Le adolescenti Katie e Becca discutono della leggenda di una videocassetta maledetta: chi la guarda muore dopo sette giorni...</p>
            </div>
          </div>
        </div>
