...
<div class="scritta">Guarda un film</div></div>
    ...
    <form>
        ...
        <div class="container1">
            <div class="image-container1">
                <img src="../immagini/antman.png">
              <div class="text-box1">
                <h2>Ant-Man and the Wasp: Quantumania, Kang e una fase 5 del MCU che parte nel caos</h2>
                <p id="firma">DI LUCA BORCHIERO</p>
                <br>
                <p id="titoletto">Ant-Man and the Wasp: Quantumania, scritto insieme al co-sceneggiatore di Rick and Morty, è un inizio caotico e piuttosto noioso per la fase 5 del MCU.</p>
                <br>
    ...
    $comment = $_POST['comment'];
      ...
      if(!empty($comment)){
        $comment = mysqli_real_escape_string($conn, $comment);
          ...
          $insert_query = "INSERT INTO comments (comment,utente,pagina)VALUES ('$comment','$username','antman')";
    ...
    <?php
      ...
      $select_query = "SELECT * FROM comments WHERE pagina='antman' ORDER BY created_at DESC";
